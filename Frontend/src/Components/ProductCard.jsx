...
const ProductCard = ({
  ...
  return (
    <Link
      ...
      className={`lg:w-fit w-full ${className}`}
    >
      <div className="whiteSoftBG shadow-md hover:shadow-lg h-auto lg:w-52 w-full overflow-hidden rounded-lg hover:scale-105 duration-300 ease-in-out flex lg:flex-col flex-row justify-between items-center ">
        ...
        <div className="h-1/3 px-2 py-3 flex flex-col w-[70%] lg:w-full">
